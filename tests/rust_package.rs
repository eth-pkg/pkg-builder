...
mod package {
    ...
    mod bookworm {
        ...
        mod rust_package {
            use env_logger::Env;
            use pkg_builder::v1::distribution::debian::bookworm::BookwormPackager;
            ...
            fn test_clean_env() {
                ...
                assert!(
                    result.is_err(),
                    "Command wasn't invoked with root privileges"
                );
            }
            ...
            fn test_create_build_env() {
                ...
                assert!(
                    result.is_err(),
                    "Command must be invoked with root privileges"
                );
            }
        }
    }
