// Ported from debcrafter (https://github.com/Kixunil/debcrafter)
// Original code by Martin Habovstiak, licensed under MIT.
// See debcrafter LICENSE for details.
//
// This module replicates the control file generation logic from
// debcrafter's binary (src/bin/generator/control.rs) so that
// pkg-builder can generate debian/ directories without requiring
// a separate debcrafter binary installation.
